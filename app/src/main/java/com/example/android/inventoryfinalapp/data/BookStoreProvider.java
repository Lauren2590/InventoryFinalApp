...
public class BookStoreProvider extends ContentProvider {
    ...
    static {
        sUriMatcher.addURI(com.example.android.inventoryfinalapp.data.BookStoreContract.CONTENT_AUTHORITY, com.example.android.inventoryfinalapp.data.BookStoreContract.PATH_BOOKS, BOOKS);
        sUriMatcher.addURI(com.example.android.inventoryfinalapp.data.BookStoreContract.CONTENT_AUTHORITY, com.example.android.inventoryfinalapp.data.BookStoreContract.PATH_BOOKS + "/#", BOOK_ID);
    }

    /**
     *  Database Helper Object
     */
    private com.example.android.inventoryfinalapp.data.BookStoreDbHelper mDbHelper;
    ...
    public boolean onCreate() {
        mDbHelper = new com.example.android.inventoryfinalapp.data.BookStoreDbHelper(getContext());
        return true;
    }
    /**
